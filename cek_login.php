...
<head>
	<meta charset="utf-8" />
	<title>::: Aplikasi Penjualan Tiket MetroMini  :::</title>
				...
				<div class="theme-login-form" align="center">
					<?php
						...
						if(empty($username)){
							...
							$login_query = mysqli_query($con, "SELECT * FROM tiket_user WHERE username='$username' AND password='$password'");
							$found_query = mysqli_num_rows($login_query);
							$view_login  = mysqli_fetch_array($login_query);
