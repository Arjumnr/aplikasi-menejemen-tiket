...
<div class="theme-content-area">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="index">
		...
		<?php
			...
			$no      = 1;
			$query = mysqli_query($con, "SELECT * FROM tiket_angkot ORDER BY id_angkot DESC LIMIT $posisi,$batas");
	...
	<?php
		/* Buat Tombol Pagging */
		$jmldata     = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tiket_angkot"));
