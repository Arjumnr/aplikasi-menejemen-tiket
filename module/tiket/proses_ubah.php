...
<div class="theme-content-area">
	<?php
		...
		if(empty($_POST['nama'])){
			...
			/* GET Tarif */
			$qtarif=mysqli_query($con,"SELECT * FROM tiket_setting WHERE id_setting='1'");
			$qdata=mysqli_fetch_array($qtarif);
			...
			mysqli_query($con, "update tiket_order set id_angkot='$id_angkot',
												nama='$nama',
												alamat='$alamat',
