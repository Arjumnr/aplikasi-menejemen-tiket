...
<div class="theme-content-area">
	<?php
		$id_order=mysqli_real_escape_string($con,$_GET['id']);
		$query=mysqli_query($con, "SELECT * FROM tiket_angkot INNER JOIN tiket_order ON tiket_angkot.id_angkot=tiket_order.id_angkot WHERE tiket_order.id_order='$id_order'");
