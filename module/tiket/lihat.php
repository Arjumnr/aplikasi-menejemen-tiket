...
<div class="theme-content-area">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="index">
		...
		<?php
			...
			$no      = 1;
			$query = mysqli_query($con, "SELECT * FROM tiket_angkot INNER JOIN tiket_order ON tiket_angkot.id_angkot=tiket_order.id_angkot ORDER BY tiket_order.id_order DESC LIMIT $posisi,$batas");
	...
	<?php
		/* Buat Tombol Pagging */
		$jmldata     = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tiket_angkot INNER JOIN tiket_order ON tiket_angkot.id_angkot=tiket_order.id_angkot"));
